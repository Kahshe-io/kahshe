        ...
        implements TrinoCatalog
{
        ...
        try {
            return uncheckedCacheGet(
                    ...
                    () -> {
                        ...
                        if (baseTable instanceof SupportsDistributedScanPlanning) {
    ...
    private static final class ServerPlannedTable
            extends BaseTable
    {
        private final BaseTable delegate;

        private ServerPlannedTable(BaseTable delegate, String name)
        {
